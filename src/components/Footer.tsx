      ...
      <div className="container mx-auto py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-300">UN Youth Delegates Albania</h3>
                <p className="text-gray-400 text-sm">UNA Albania</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md pt-2">
              Programi i Delegatëve të Rinj të Kombeve të Bashkuara në Shqipëri mundëson për të rinjtë shqiptarë të përfaqësojnë vendin tonë në arenën ndërkombëtare.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-6 pt-2 text-gray-300">Lidhje të Shpejta</h4>
            <ul className="space-y-3">
              ...
              <li>
                <a href="#aplikimi" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Statusi i Aplikimit
                </a>
              </li>
              <li>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-lg font-semibold mb-6 pt-2 text-gray-300">Burime</h4>
            <ul className="space-y-3">
              <li>
        ...
        <div className="border-t border-gray-800 pt-12 mt-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="pt-4">
              <h4 className="text-xl font-semibold mb-2 text-gray-300">Qëndro i informuar për 2026</h4>
              <p className="text-gray-400">
                Regjistrohu për të marrë njoftimet e para kur të hapen aplikimet për vitin 2026.
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 pt-12 mt-8 pb-10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex space-x-6 pt-4">
              {/* UNA Albania Social */}
              <a 
                href="https://instagram.com/una_albania" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              {/* UNYD Albania Social */}
              <a 
                href="https://instagram.com/unydalbania" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors"
              ...
              <a 
                href="https://instagram.com/blueprintalbania" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors"
                aria-label="Blueprint Albania Instagram"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.40z"/>
                </svg>
            ...
            <div className="text-center md:text-right pt-4">
              <p className="text-gray-400 text-sm">
                © 2025 UNA Albania. Të gjitha të drejtat e rezervuara.
              </p>
